...
class Entry:
    ...
    is_excluded_from_reports = False  # For US-19; whether this entry should be excluded from weekly/monthly reviews
    ...
    def __init__(
        ...
        self.is_excluded_from_reports = False  # By default, entry is included in reports
    ...
    def is_excluded_from_reports_check(self) -> bool:
        """
        Returns True if this entry should be excluded from weekly/monthly reports.
        """
        return self.is_excluded_from_reports

    def set_excluded_from_reports(self, excluded: bool) -> None:
        """
        Sets whether this entry should be excluded from weekly/monthly reports.
        """
        self.is_excluded_from_reports = excluded
